...
# config_uav = holoocean.packagemanager.get_scenario(scenario)
...
# data_uav = np.zeros_like(R_uav)
# plot_laser = plt.pcolormesh(T_uav, R_uav, data_uav, cmap='gray', shading='auto', vmin=0, vmax=1)



torques_uav = np.array([0, 0, 0, 0])
...
for i in range(300000):
    ...
    env.act('auv1', np.array([0,0,0,0,0,0,0,0]))
    ...
    """ if 'RangeFinderSensor' in states["auv0"]:
        ...
        print(data_uav)
        #data[:,0] = states["auv0"]['RangeFinderSensor']
